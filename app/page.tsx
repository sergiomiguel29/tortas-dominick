  ...
  return <main>
    ...
    <header className="header">
      ...
      <nav className={menuOpen ? "nav open" : "nav"} aria-label="Navegación principal">
        <a className="active" href="/" onClick={() => setMenuOpen(false)}>Inicio</a><a href="/tortas" onClick={() => setMenuOpen(false)}>Tortas</a><a href="/postres" onClick={() => setMenuOpen(false)}>Postres</a><a href="/disenos" onClick={() => setMenuOpen(false)}>Diseños</a><a href="/nosotros" onClick={() => setMenuOpen(false)}>Nosotros</a><a href="/contacto" onClick={() => setMenuOpen(false)}>Contacto</a>
      </nav>
    ...
    <footer id="contacto"><div className="footer-brand"><a className="brand light" href="/"><b>Dominick</b><small>PASTELERÍA</small></a><p>Hechas con amor,<br/>deliciosas por naturaleza.</p><div><a href="https://www.instagram.com/tortas_dominick/" target="_blank" rel="noreferrer"><Icon name="instagram"/></a><a href={whatsapp} target="_blank" rel="noreferrer"><Icon name="whatsapp"/></a></div></div><div className="footer-links"><b>Navegación</b><a href="/">Inicio</a><a href="/tortas">Tortas</a><a href="/postres">Postres</a><a href="/disenos">Diseños</a></div><div className="footer-links"><b>Contacto</b><span>Lima, Perú</span><a href={`tel:+${branch.phone}`}>{branch.label}</a><a href="https://www.instagram.com/tortas_dominick/" target="_blank" rel="noreferrer">@tortas_dominick</a></div><div className="footer-news"><b>Recibe nuestras novedades</b><p>Ofertas, lanzamientos y mucho más.</p><a href={whatsapp} target="_blank" rel="noreferrer">Escríbenos por WhatsApp <Icon name="arrow"/></a></div><small className="copyright">© 2026 Tortas Dominick. Todos los derechos reservados.</small></footer>
