...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Tortas Dominick", description: "Momentos que saben mejor.", type: "website", images: [{ url: "/og.png", width: 1760, height: 917, alt: "Dominick — Momentos que saben mejor" }] },
